...
//
////////////////////////////////////////////////////////////////////////////////
package org.apache.flex.spark.components.progressBar
{
	...
	import org.apache.flex.spark.skins.spark.ProgressBarSkin;
	...
	{		
		...
		protected static function setDefaultStyles(factory:IFlexModuleFactory):void
		{
			...
			if( style.defaultFactory == null )
			{
				...
				{
					this.skinClass = org.apache.flex.spark.skins.spark.ProgressBarSkin;
				};
			}
		}
	}
