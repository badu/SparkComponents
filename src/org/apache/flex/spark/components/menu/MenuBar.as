...
//
////////////////////////////////////////////////////////////////////////////////
package org.apache.flex.spark.components.menu
{
    ...
    import org.apache.flex.spark.events.MenuEvent;
    import org.apache.flex.spark.interfaces.IListItemRenderer;
    import org.apache.flex.spark.skins.spark.MenuBarSkin;
    ...
    {		
		...
		private static function setDefaultStyles( factory:IFlexModuleFactory ):void
		{
			...
			if( style.defaultFactory == null )
			{
				...
				{
					this.skinClass = org.apache.flex.spark.skins.spark.MenuBarSkin;
				};
			}
		}	
    }
