...
//
////////////////////////////////////////////////////////////////////////////////
package org.apache.flex.spark.components.colorpicker 
{	
	...
	import org.apache.flex.spark.skins.spark.ColorPickerSkin;
	 ...
	 */
	[Event(name="choose", type="org.apache.flex.spark.events.ColorChangeEvent")]
	/**
	 ...
	 *  @productversion Flex 4.5
	 */
	[Event(name="hover", type="org.apache.flex.spark.events.ColorChangeEvent")]
	/**
	 *  @langversion 3.0
	 *  @playerversion Flash 10.1
	 *  @playerversion AIR 2.5
	...
	{		
		...
		private static function setDefaultStyles( factory:IFlexModuleFactory ):void
		{
			...
			if( style.defaultFactory == null )
			{
				...
				{
					this.skinClass = org.apache.flex.spark.skins.spark.ColorPickerSkin;
				};
			}
		}	
	}	
