...
//
////////////////////////////////////////////////////////////////////////////////
package org.apache.flex.spark.components.alert
{
	...
	import org.apache.flex.spark.skins.spark.AlertSkin;
	 ...
	 *
	 *  <p>Import the org.apache.flex.spark.components.alert.Alert class into your application,
	...
	public class Alert extends Panel
	{
		...
		private static function setDefaultStyles( factory:IFlexModuleFactory ):void
		{
			...
			if( style.defaultFactory == null )
			{
				...
				{
					this.skinClass = org.apache.flex.spark.skins.spark.AlertSkin;
				};
			}
		}
	}
